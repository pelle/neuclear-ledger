...
public class InsufficientFundsException extends InvalidTransactionException {
    public InsufficientFundsException(final Ledger ledger, final String book, final double amount, final double balance) {
        super(ledger, " Insufficient funds in account: " + book + " to cover the amount: " + amount + " available: " + balance);
        this.amount = amount;
        this.book = book;
    }

    public InsufficientFundsException(final Ledger ledger, final String book, final double amount) {
